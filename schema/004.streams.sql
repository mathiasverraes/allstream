...
(
    ...
    lifecycle_start_events DOMAIN_EVENT_TYPE[],
    lifecycle_end_events   DOMAIN_EVENT_TYPE[]
);
...
CREATE FUNCTION register_new_stream(_stream_type SYMBOL, _stream_id UUID)
    RETURNS INTEGER AS
$$
DECLARE
...
BEGIN
    ...
    EXECUTE format('CREATE TABLE %I (LIKE _template_for_stream_table INCLUDING ALL)', _new_table_name);
