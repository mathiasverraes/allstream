...
CREATE PROCEDURE append(_event_id uuid, _event_type domain_event_type
                       , _event_payload jsonb)
AS
$$
BEGIN
    INSERT INTO events (event_id, event_type, event_payload)
    VALUES (_event_id, _event_type, _event_payload);
END;
$$ LANGUAGE plpgsql;
